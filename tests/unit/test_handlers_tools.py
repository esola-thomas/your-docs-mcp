...
from hierarchical_docs_mcp.models.navigation import Category, NavigationContext, SearchResult
...
class TestHandleGetDocument:
    ...
    async def test_get_document_handles_exception(self, sample_documents):
        ...
        with patch("hierarchical_docs_mcp.handlers.tools.logger") as mock_logger:
