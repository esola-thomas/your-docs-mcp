...
class DocumentValidator:
    ...
    VALID_CATEGORIES = [
        'Guides', 'API Reference', 'Architecture', 'Configuration',
        'Security', 'Development', 'Tutorials'
    ]
    MAX_LINE_LENGTH = 100
    ...
    def _validate_headers(self, file_path: Path, lines: List[str],
                         result: ValidationResult) -> None:
    ...
    def _validate_code_blocks(self, file_path: Path, lines: List[str],
                             result: ValidationResult) -> None:
    ...
    def _validate_line_length(self, file_path: Path, lines: List[str],
                             result: ValidationResult) -> None:
    ...
    def _validate_links(self, file_path: Path, lines: List[str],
                       result: ValidationResult) -> None:
    ...
    def _validate_lists(self, file_path: Path, lines: List[str],
                       result: ValidationResult) -> None:
    ...
    @staticmethod
    def _get_yaml_error_line(error_msg: str) -> Optional[int]:
...
def main():
    ...
    parser.add_argument(
        '--no-warnings',
        action='store_true',
        help='Only report critical issues'
    )
    ...
    for file_path in sorted(files_to_validate):
        ...
        if result.passed:
            ...
            print(f"❌ {file_path} ({result.critical_count} critical, "
