...
from docs_mcp.core.models.navigation import Category, SearchResult
from docs_mcp.core.security.sanitizer import sanitize_query
from docs_mcp.core.services.cache import get_cache
from docs_mcp.core.services.hierarchy import get_breadcrumbs
...
def _get_vector_store():  # type: ignore[no-untyped-def]
    """Lazy import of vector store to avoid hard dependency."""
    try:
    ...
    try:
        ...
        try:
            ...
            if vector_store and vector_store.collection:
                vector_hits = vector_store.search(sanitized_query, limit=limit * 2)
